...
It works with single-site or multi-site BuddyPress installs. Both the main site and child blogs can run multilingual.

Guest blogs can choose their language and create multilingual contents.
 Additionally, each guest can choose the admin language individually.
...
BuddyPress itself uses virtual directories for its elements. 
The only way we managed to add language information is by adding a language prefix to paths.
