<?php
$lang_IT = array();
$lang_IT['Attivita']= "Attivit&agrave;";
$lang_IT['Messaggi']= "Messaggi";
$lang_IT['Recensioni']= "Recensioni";
$lang_IT['Offerte']= "Offerte";
$lang_IT['Manca poco']= "Manca poco, stiamo implementando una nuova funzionalita' che vi permettera' di realizzare una vetrina dei vostri prodotti e servizi. \n\nContinuate a sostenerci. \n - Lo staff.";
$lang_IT['Che cosa siamo?']= "Che cosa siamo?";
$lang_IT['Chi Siamo']= "		
			<p>
				...
				Best2best &egrave; la novit&agrave; nel mondo del B2B per il settore turismo.
			</p>
