...
Version: 3.1
Author: Andrea Tarantini, Giovanni Giannone, Andrea Sangiorgio
...
function bps_set_default_options ()
{
	...
	$bps_options['header'] = ''; //'<h4>Advanced Search</h4>';					//nisba
	$bps_options['show'] = array ('Enabled');
	$bps_options['message'] = 'Mostra'; //'Toggle Form';							//italiano
