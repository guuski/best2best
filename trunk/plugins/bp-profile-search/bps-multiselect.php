...
/**
 * Questa funzione controlla se nella tabella wp_bp_xprofile_fields è presente un record con descriptio = ms Categorie Acquisti. 
 * in questo caso ho gia provveduto all'aggiornamento del database
 *
 */
...
/**
 *
 * Questo metodo mi ritorna l'id del nuovo field creato dall'utente oppure ritorna -1 in caso di assenza del field 
 *
 */
 ...
 * METODO DA TESTARE
 *  
 * Questa funzione recupera le categorie associate all'utente presenti in buddypress.wp_bp_xprofile_data
 *
 */
...
function bps_updateDBfield()
{
	...
	$bps_parent = bps_newfieldisset();																// F - bps_newfieldisset()
...
/**
 *
 * Questo metodo leggendo da DB restituisce una matrice contenente tutte le categorie e le sottocategorie
 *
 */
...
function bps_getHTMLfrontend()
{
	...
	$HTML= bps_getScript();																								// F - bps_getScript()
	$HTML.="<div class='bps_divfrontend'>";
	
	$HTML.=bps_getHTML_ric($bps_insert,$bps_mycategorie);																// F - bps_getHTML_ric()
