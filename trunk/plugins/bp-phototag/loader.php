<?php
/*
Plugin Name: BP Photos+tags
Plugin URI: http://bp-photos-tags.jessesoffice.com/
Description: Photo Albums for BuddyPress with friend tagging (like facebook). Includes Posts to Wire, Member Comments, and Gallery Privacy Controls. Works with current BuddyPress theme and includes Easy To Skin Templates.
Version: 1.1
Revision Date: August 22, 2011
...
function bp_album_compatibility_notices() {
	...
	if (!defined('BP_VERSION')){    
		$message .= ' BP Photos+tags needs BuddyPress 1.2 or later to work. Please install Buddypress';
		
		echo '<div class="error fade"><p>'.$message.'</p></div>';
		
	}elseif(version_compare(BP_VERSION, '1.2','<') ){
		$message .= 'BP Photos+tags needs BuddyPress 1.2 or later to work. Your current version is '.BP_VERSION.' please upgrade.';
