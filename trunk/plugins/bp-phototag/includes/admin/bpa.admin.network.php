...
function bp_album_admin() {
	...
	<div class="wrap">
		...
		<h2><?php _e('BP Photos+tags - ', 'bp-phototag' ) ?> 1.1<?php _e(' - [Network Mode]', 'bp-phototag' ) ?></h2>
		<br />
		...
		<form action="<?php echo site_url() . '/wp-admin/network/admin.php?page=bp-phototag-settings' ?>" name="example-settings-form" id="example-settings-form" method="post">
			...
			<table class="form-table">
			    <tr valign="top">
					<th scope="row"><label for="target_uri"><?php _e('Maximum file (mb) size that can be uploaded', 'bp-phototag' ) ?></label></th>
					<td>
