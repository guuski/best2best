...
add_action(	'admin_menu'		 , 'bp_wpps_plugin_menu');
//add_action( 'network_admin_menu' , 'bp_wpps_plugin_menu' );

function bp_wpps_plugin_menu() 
{
	add_submenu_page( 'bp-general-settings', 'BP-WP-Profile sync', 'BP-WP-Profile sync', 'manage_options', 'bp_wpps', 'bp_wpps_plugin_options');
		
	add_action( 'admin_init', 'bp_wpps_register_settings' );
}



function bp_wpps_register_settings() 
{

	register_setting( 'bptwittercj_plugin_options'	  , 'bp_wpps-members' );
	...
	register_setting( 'bp_wpps_plugin_options', 'bp_wpps_member_label' );

	//name to cerrelate to the gropus field label
	register_setting( 'bp_wpps_plugin_options', 'bp_wpps_group_label' );
}


function bp_wpps_plugin_options() 
{
...
<h2>
<?php _e(' Settings', 'bp_wpps') ?>
</h2>


<h3><?php _e('Member and Group Components.', 'bp_wpps') ?></h3>
...
<h3><?php _e('Display Settings.', 'bp_wpps') ?></h3>
