...
$tabellaGruppi = 'wp_bp_xprofile_groups';
...
/*INSERIMENTI=========================================================*/
$id_start=0;	//dovrei fare una select per individuare l'id massimo e da quello costruire tutto il resto :) 
$group_id=4;	//credo sia opportuno creare un nuovo gruppo nella tabella wp_bp_xprofile_groups
//$parent_id
$type ='textarea';
//$name
$description='Categorie Acquisti';
$is_required=0;
$is_default_option=0;
$field_order=0;
$option_order=0; 
...
$ins = "INSERT INTO $tabella 
	(id , group_id, parent_id, type, name , description , is_required , is_default_option, field_order, option_order , order_by, can_delete)
VALUES ";
